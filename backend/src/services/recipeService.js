const recipeRepository = require('../database/repositories/recipeRepository');
...
module.exports = class recipeservice {
  ...
  /**
   * Destroy all recipes with those ids.
   *
   * @param {*} ids
   */
  ...
  /**
   * Finds recipes for Autocomplete.
   *
   * @param {*} search
   * @param {*} limit
   */
  ...
  /**
   * Finds recipes based on the query.
   *
   * @param {*} args
   */
