...
<script>
import RemovemeFormModal from '@/modules/removeme/components/removeme-form-modal';
import { RemovemePermissions } from '@/modules/removeme/removeme-permissions';
import { mapGetters } from 'vuex';

export default {
  name: 'app-removeme-autocomplete-input',
  props: [
    'value',
    'mode',
    'fetchFn',
  ...
  components: {
    [RemovemeFormModal.name]: RemovemeFormModal,
  },
