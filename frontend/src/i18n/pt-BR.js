const ptBR = {
  ...
  entities: {
    removeme: {
      ...
      label: 'Removemes',
      menu: 'Removemes',
      exporterFileName: 'Removeme_exportados',
      list: {
        menu: 'Removemes',
        title: 'Removemes',
      },
      create: {
        success: 'Removeme salvo com sucesso',
      },
      update: {
        success: 'Removeme salvo com sucesso',
      },
      destroy: {
        success: 'Removeme deletado com sucesso',
      },
      destroyAll: {
        success: 'Removeme(s) deletado com sucesso',
      },
      edit: {
        title: 'Editar Removeme',
      },
      fields: {
        id: 'Id',
      ...
      view: {
        title: 'Visualizar Removeme',
      },
      importer: {
        title: 'Importar Removemes',
        fileName: 'removeme_template_importacao',
        hint:
  ...
  roles: {
    ...
    removemeEditor: {
      label: 'Editor de Removemes',
      description: 'Acesso de edição aos Removemes',
    },
    removemeViewer: {
      label: 'Visualizador de Removemes',
      description: 'Acesso de visualização aos Removemes',
    },
  },
